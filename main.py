...
class ParserDiscovery:
    ...
    def _load_parser(self, parser_name: str) -> Optional[type]:
...
class TestDatasetGenerator:
    ...
    def _create_dataset(self, size: int) -> TestDataset:
...
class MetricsCollector:
    ...
    def stop_collection(self, cpu_start: Any, time_start: float) -> Tuple[float, int, int]:
...
class SingleRunBenchmark:
    ...
    def _run_benchmark(self, parser_class: type, dataset: TestDataset, 
        ...
        cpu_start, time_start = self._metrics_collector.start_collection()
    ...
    def _update_metrics(self, metrics: BenchmarkMetrics, serialize_timer: Timer,
...
class ParallelBenchmark:
    ...
    def execute(self, parser_class: type, dataset: TestDataset) -> Dict[str, Any]:
...
class SpeedupCalculator:
    ...
    def calculate_speedup(self, sequential_times: List[float], 
...
class BenchmarkSummaryGenerator:
    ...
    def _print_success_rate(self, results: List[Dict[str, Any]]) -> None:
    ...
    def _print_top_performers(self, results: List[Dict[str, Any]]) -> None:
    ...
    def _print_average_times(self, results: List[Dict[str, Any]], 

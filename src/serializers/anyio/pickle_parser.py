...
This module *previously* implemented an async streaming JSON parser with Pickle-style processing.
...
class StreamingJsonParser:
    ...
    def consume(self, chunk: str) -> None:
        ...
        if not isinstance(chunk, str):
            # As per new constraints, consume must accept str.
            # However, this parser's internal logic is byte-based.
            # This path should ideally not be hit if type hints are respected by callers.
...
# --- Original Async Pickle-inspired helper classes (now unused by StreamingJsonParser) ---
@dataclass
...
class AsyncPickleValidator: # Original class
...
class AsyncPickleExtractor: # Original class
...
class AsyncPickleParser: # Original class
...
class AsyncPickleProcessor: # Original class
